...
const SubjectSummariesPage = lazy(() => import("./pages/SubjectSummariesPage"));
// Group AI-related pages together for better chunking
const AiAssistantUploadPage = lazy(
  () => import("./pages/AiAssistantUploadPage")
);
...
function SummaryDetailPageWrapper({
  onNavigate,
}: {
  ...
  return (
    <SummaryDetailPage summaryId={summaryId || ""} onNavigate={onNavigate} />
  );
}

function EditSummaryPageWrapper({
  onNavigate,
}: {
  onNavigate: (page: string, id?: string) => void;
}) {
